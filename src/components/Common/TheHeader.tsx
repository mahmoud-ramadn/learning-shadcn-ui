...
function TheHeader() {
  ...
  const hande = (e: { preventDefault: () => void; stopPropagation: () => void; }) => {
    e.preventDefault();
    e.stopPropagation(); // Prevent the sheet from closing
    console.log('hi');
    setToggle(!toggle);
    setIsSheetOpen(true); // Keep the sheet open
  };
              ...
              <div className="w-[720px] text-center">
                ...
                <form className="flex flex-col items-center gap-3">
                  ...
                  <p className="font-semibold cursor-pointer text-body-sub">
                    ...
                    <span onClick={hande} className="text-primary-500">
                      Login
                    </span>
                  </p>
                </form>
